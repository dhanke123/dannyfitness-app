...
export function AppProvider({ children }) {
  ...
  const [menuConfig, setMenuConfig] = useState(null); // null = not loaded yet; MenuManagement sets defaults on first open
